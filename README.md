...
g++ -o DevRanger.out main.cpp Game.cpp States/GameState.cpp Entities/Entity.cpp Entities/Player.cpp States/State.cpp -lsfml-audio -lsfml-graphics -lsfml-window -lsfml-system
